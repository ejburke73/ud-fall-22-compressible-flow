...
ax.set_title('Mach vs. Time')
ax.legend()
plt.savefig('../images/problem_1/Mach_vs_Time.png')
plt.close()
...
plt.savefig('../images/problem_1/Mach_Error_vs_Time.png')
plt.close()
...
plt.savefig('../images/problem_1/rho_rho_t_vs_Time.png')
plt.close()
...
plt.savefig('../images/problem_1/rho_rho_t_vs_Mach.png')
plt.close()
...
plt.savefig('../images/problem_1/rho_rho_t_and_Mach_vs_Time_marked.png')
#plt.close()
ann1.remove()
ann2.remove()
...
plt.savefig('../images/problem_1/rho_rho_t_and_Mach_vs_Time_marked_zoom.png')
plt.close()
...
ax.legend()
plt.savefig('../images/problem_1/Pt_vs_Time_Isen_Bernoulli.png')
plt.close()
